...
export type ConfigArgs = {
  authority: Address;
  treasuryPubkey: Address;
  minGoal: number | bigint;
  minWithdrawal: number | bigint;
...
export function getConfigEncoder(): FixedSizeEncoder<ConfigArgs> {
  return transformEncoder(
    getStructEncoder([
      ...
      ['treasuryPubkey', getAddressEncoder()],
      ['minGoal', getU64Encoder()],
      ['minWithdrawal', getU64Encoder()],
      ['platformFeeBps', getU64Encoder()],
    ]),
...
export function getConfigDecoder(): FixedSizeDecoder<Config> {
  return getStructDecoder([
    ...
    ['treasuryPubkey', getAddressDecoder()],
    ['minGoal', getU64Decoder()],
    ['minWithdrawal', getU64Decoder()],
    ['platformFeeBps', getU64Decoder()],
  ]);
}
